...
function AddixsButton(form) {
	form.setScript('customscript_h5_rate_shipment_bttn');
	form.addButton('custpage_setrate', 'IXS Rates', 'getRLRates()');
}
function getRLRates() {
	var recName = nlapiGetRecordId();
	var batId = Date.now();
...
///app/site/hosting/scriptlet.nl?script=171&deploy=1&compid=TSTDRV1555013&NLNAME=1&batchId=1577735475856
...
function h5ShipGenInit(){
	...
	//}
	//else {
	var shipRecURL = nlapiResolveURL('SUITELET', 'customscript_h5_ship_rec', 'customdeploy_h5_ship_rec');

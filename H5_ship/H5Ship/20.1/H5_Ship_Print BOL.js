function printBOL(request, response){
    ...
    //var shipName = record.getFieldText('custrecord_h5_shipper');
    ...
    //var ConsEnt = record.getFieldValue('custrecord_h5_consignee');
		var consigneeAttn = record.getFieldValue('custrecord_h5_consignee_attn');
		if(consigneeAttn === null){consigneeAttn = '';}
    var consigneeName = record.getFieldValue('custrecord_h5_consignee_addree');
    ...
    var BillToName = record.getFieldText('custrecord_h5_freight_bill_to');

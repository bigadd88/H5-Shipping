...
function getRatepass(request, response) {
  ...
  var col = new Array();
      ...
      col[2] = new nlobjSearchColumn('custrecord_pss_nmfc_short_desc_line');
      ...
      col[7] = new nlobjSearchColumn('custrecord_pss_pallet_count');
  var packages = nlapiSearchRecord('customrecord_pss_shipment_line', null, fil, col);
      for (var x = 0; x < packages.length; x++){
      pkgcount.push(packages[x].getValue('custrecord_pss_pallet_count'));
      }
  ...
  var origCity = parentShipment.getFieldValue('custrecord_pss_shipper_city');
  var destinationZip =parentShipment.getFieldValue('custrecord_pss_consignee_zip');
  var destCity =parentShipment.getFieldValue('custrecord_pss_consignee_city');
...
function P44getRatepass(request, response) {
  ...
  var col = [];
      ...
      col[5] = new nlobjSearchColumn('custrecord_pss_weight');
      col[6] = new nlobjSearchColumn('custrecord_pss_nmfc_number_line');
  	  col[7] = new nlobjSearchColumn('custrecord_pss_length');
  	  col[8] = new nlobjSearchColumn('custrecord_pss_width');
  	  col[9] = new nlobjSearchColumn('custrecord_pss_height');
  var packages = nlapiSearchRecord('customrecord_pss_shipment_line', null, fil, col);
      for (var x = 0; x < packages.length; x++){
      pkgcount.push(packages[x].getValue('custrecord_pss_pkgnumber'));
      pkgFreightClass.push(packages[x].getValue('custrecord_pss_freight_class_value'));
      pkgWeight.push(packages[x].getValue('custrecord_pss_weight'));
      pkgLength.push(packages[x].getValue('custrecord_pss_length'));
      pkgWidth.push(packages[x].getValue('custrecord_pss_width'));
      pkgHeight.push(packages[x].getValue('custrecord_pss_height'));
      }
  var pkgcnt = Math.max.apply(null,pkgcount);
  ...
  //var originEntId = parentShipment.getFieldValue('custrecord_pss_shipper');
  ...
  var originZip = parentShipment.getFieldValue('custrecord_pss_shipper_zip');
  var origAddr1 = parentShipment.getFieldValue('custrecord_pss_shipper_addr1');
  var origCity = parentShipment.getFieldValue('custrecord_pss_shipper_city');
  var origState = parentShipment.getFieldValue('custrecord_pss_shipper_state');
  //var destEntId = parentShipment.getFieldValue('custrecord_pss_consignee');
  //var destEnt = nlapiLoadRecord('customer', destEntId);
    ...
    var consigneeAddr1 = parentShipment.getFieldValue('custrecord_pss_consingee_addr1');
  ...
  //var destAddr1 = parentShipment.getFieldValue('custrecord_pss_consingee_addr1');
  //var destCity = parentShipment.getFieldValue('custrecord_pss_consignee_city');
  //var destState = parentShipment.getFieldValue('custrecord_pss_consignee_state');
  var shipmentDate = parentShipment.getFieldValue('custrecord_pss_ship_date');
  var linItems = [];
  ...
  for (i = 0; i < rates.length; i++) {
    ...
    if (rates[i].hasOwnProperty('transitDays')){TransitDays.push(rates[i].transitDays);} else {TransitDays.push(0);}
  	...
  	rateLine.setFieldValue('custrecord_pss_ratepass_shipment_id', recId);
  	rateLine.setFieldValue('custrecord_pss_ratepass_id', i + 1);
  	rateLine.setFieldValue('custrecord_pss_carrier_quote_num', CarrierQuoteNo[i]);
  	//rateLine.setFieldValue('custrecord_pss_discount', Discount);
  	//rateLine.setFieldValue('custrecord_pss_discount_rate', DiscountRate);
  	//rateLine.setFieldValue('custrecord_pss_error_message', ErrorMessage);
  	//rateLine.setFieldValue('custrecord_pss_fuel_surcharge', FuelSurcharge);
  	...
  	//rateLine.setFieldValue('custrecord_pss_payment_type', PaymentType);
  	//rateLine.setFieldValue('custrecord_pss_saas_quote_num', SAASQuoteNumber);
  	rateLine.setFieldValue('custrecord_pss_scac', SCAC[i]);
  	rateLine.setFieldValue('custrecord_pss_service_level_desc', serviceLevel[i]);
  	rateLine.setFieldValue('custrecord_pss_total_shipment_cost', TotalShipmentCost[i]);
  	rateLine.setFieldValue('custrecord_pss_transit_days', TransitDays[i]);
  	//rateLine.setFieldValue('custrecord_pss_ratepass_carrier', carrier);
  	rateLine.setFieldValue('custrecord_pss_ratepass_total_cost', TotalShipmentCost[i]);
  	rateLine.setFieldValue('custrecord_pss_ratepass_origin_zip', originZip);
  	rateLine.setFieldValue('custrecord_pss_ratepass_destination_zip', consigneeZip);
  	//rateLine.setFieldValue('custrecord_pss_ratepass_pf_code', profileCode);
  	//rateLine.setFieldValue('custrecord_pss_ratepass_client_code', clientCode);
  	//rateLine.setFieldValue('custrecord_pss_acc_rated', accessorialsRated);
  	//rateLine.setFieldValue('custrecord_pss_CarrierType', CarrierType);
...
function CHRgetRatepass(request, response) {
    ...
    col[1] = new nlobjSearchColumn('custrecord_pss_pallet_count');
    col[2] = new nlobjSearchColumn('custrecord_pss_piece_count');
    col[3] = new nlobjSearchColumn('custrecord_pss_packagetype');
    col[4] = new nlobjSearchColumn('custrecord_pss_ship_line_item_desc');
    col[5] = new nlobjSearchColumn('custrecord_pss_freight_class_value');
    col[6] = new nlobjSearchColumn('custrecord_pss_weight');
    col[7] = new nlobjSearchColumn('custrecord_pss_length');
    col[8] = new nlobjSearchColumn('custrecord_pss_width');
    col[9] = new nlobjSearchColumn('custrecord_pss_height');
    col[10] = new nlobjSearchColumn('custrecord_pss_hazmat');
    col[11] = new nlobjSearchColumn('custrecord_pss_nmfc_number');
    col[12] = new nlobjSearchColumn('custrecord_pss_inventoryunits');
    var packages = nlapiSearchRecord('customrecord_pss_shipment_line', null, fil, col);
    for (var x = 0; x < packages.length; x++){
        linePkgNumber.push(packages[x].getValue('custrecord_pss_pkgnumber'));
        linePalletCount.push(packages[x].getValue('custrecord_pss_pallet_count'));
        linePieceCount.push(packages[x].getValue('custrecord_pss_piece_count'));
        linePackageType.push(packages[x].getValue('custrecord_pss_packagetype'));
        lineDesc.push(packages[x].getValue('custrecord_pss_ship_line_item_desc'));
        lineFrtClass.push(packages[x].getValue('custrecord_pss_freight_class_value'));
        lineWeight.push(packages[x].getValue('custrecord_pss_weight'));
        lineLength.push(packages[x].getValue('custrecord_pss_length'));
        lineWidth.push(packages[x].getValue('custrecord_pss_width'));
        lineHeight.push(packages[x].getValue('custrecord_pss_height'));
        lineHazmat.push(packages[x].getValue('custrecord_pss_hazmat'));
        lineNMFC.push(packages[x].getValue('custrecord_pss_nmfc_number'));
        lineInventoryUnits.push(packages[x].getValue('custrecord_pss_inventoryunits'));
    }
    var pkgcnt = Math.max.apply(null,linePkgNumber);

    var originCountry = parentShipment.getFieldValue('custrecord_pss_shipper_country');
    var originZip = parentShipment.getFieldValue('custrecord_pss_shipper_zip');
    var origAddr1 = parentShipment.getFieldValue('custrecord_pss_shipper_addr_1');
    var origCity = parentShipment.getFieldValue('custrecord_pss_shipper_city');
    var origState = parentShipment.getFieldValue('custrecord_pss_shipper_state');
    //var destEntId = parentShipment.getFieldValue('custrecord_pss_consignee');
    //var destEnt = nlapiLoadRecord('customer', destEntId);
    ...
    var origLiftGate = parentShipment.getFieldValue('custrecord_pss_orig_chr_liftgate');
    if (origLiftGate === 'T'){origLiftGate = 'true'} else {origLiftGate = 'false'}
    var origInsidePickup = parentShipment.getFieldValue('custrecord_pss_orig_chr_insidepickup');
    if (origInsidePickup === 'T'){origInsidePickup = 'true'} else {origInsidePickup = 'false'}
    var origInsideDelivery = parentShipment.getFieldValue('custrecord_pss_orig_chr_insidedelivery');
    if (origInsideDelivery === 'T'){origInsideDelivery = 'true'} else {origInsideDelivery = 'false'}
    var origResidential = parentShipment.getFieldValue('custrecord_pss_orig_chr_residential');
    if (origResidential === 'T'){origResidential = 'true'} else {origResidential = 'false'}
    var origLimitedAccess = parentShipment.getFieldValue('custrecord_pss_orig_chr_limitedaccess');
    if (origLimitedAccess === 'T'){origLimitedAccess = 'true'} else {origLimitedAccess = 'false'}
    var origConstruction = parentShipment.getFieldValue('custrecord_pss_orig_chr_construction');
    if (origConstruction === 'T'){origConstruction = 'true'} else {origConstruction = 'false'}
    var destLiftGate = parentShipment.getFieldValue('custrecord_pss_dest_chr_liftgate');
    if (destLiftGate === 'T'){destLiftGate = 'true'} else {destLiftGate = 'false'}
    var destInsidePickup = parentShipment.getFieldValue('custrecord_pss_dest_chr_insidepickup');
    if (destInsidePickup === 'T'){destInsidePickup = 'true'} else {destInsidePickup = 'false'}
    var destInsideDelivery = parentShipment.getFieldValue('custrecord_pss_dest_chr_insidedelivery');
    if (destInsideDelivery === 'T'){destInsideDelivery = 'true'} else {destInsideDelivery = 'false'}
    var destResidential = parentShipment.getFieldValue('custrecord_pss_dest_chr_residential');
    if (destResidential === 'T'){destResidential = 'true'} else {destResidential = 'false'}
    var destLimitedAccess = parentShipment.getFieldValue('custrecord_pss_dest_chr_limitedaccess');
    if (destLimitedAccess === 'T'){destLimitedAccess = 'true'} else {destLimitedAccess = 'false'}
    var destConstruction = parentShipment.getFieldValue('custrecord_pss_dest_chr_construction');
    if (destConstruction === 'T'){destConstruction = 'true'} else {destConstruction = 'false'}
    var refAtPickup = parentShipment.getFieldValue('custrecord_pss_reference_pickup');
    var refAtDestination = parentShipment.getFieldValue('custrecord_pss_reference_delivery');
    var shipperLoc = parentShipment.getFieldValue('custrecord_pss_location');
    var customerCodeCHR = nlapiLookupField('location',shipperLoc, 'custrecord_pss_chr_accountnumber');
    var shipmentName = parentShipment.getFieldValue('name');
    var declaredValue = parentShipment.getFieldValue('custrecord_pss_shiprec_declared_value');
    // var accessorials = GetCHRAccessorials(parentShipment);
    //var CHRAccessorials = parentShipment.getFieldValue('custrecord_pss_accessorials');
    ...
    if (respObj.statusCode === 400){
        ...
        for (i = 0; i < rates.length; i++) {
            ...
            rateLine.setFieldValue('custrecord_pss_carrier_quote_num', CarrierQuoteNo[i]);
            rateLine.setFieldValue('custrecord_pss_scac', SCAC[i]);
            rateLine.setFieldValue('custrecord_pss_ratepass_carrier', carrierName[i]);
            rateLine.setFieldValue('custrecord_pss_service_level_desc', destinationServiceLevel[i]);
            rateLine.setFieldValue('custrecord_pss_total_shipment_cost', TotalShipmentCost[i]);
            rateLine.setFieldValue('custrecord_pss_transit_days', TransitDays[i]);
            rateLine.setFieldValue('custrecord_pss_fuel_surcharge', totalAccessorialCharge[i]);
            rateLine.setFieldValue('custrecord_pss_ratepass_total_cost', TotalShipmentCost[i]);
            rateLine.setFieldValue('custrecord_pss_ratepass_origin_zip', originZip);
            rateLine.setFieldValue('custrecord_pss_ratepass_destination_zip', consigneeZip);
            rateLine.setFieldValue('custrecord_pss_lane_name', 'CH Robinson');
            nlapiSubmitRecord(rateLine);
        }
...
function GetAccessorials(parentShipment) {
  //Build the Accessorial Array
      	...
      	if (selAccessorials != ''){
      		...
      		var accCol = [];
      			accCol[0] = new nlobjSearchColumn('custrecord_pss_ratecode_e1');
      		var selAccNames = nlapiSearchRecord('customrecord_pss_accessorials', null, accFil, accCol);
      		for (y = 0; y < selAccNames.length; y++){
          	selAccNamesPrnt.push(selAccNames[y].getValue('custrecord_pss_ratecode_e1'));
        	}
...
function GetP44Accessorials(parentShipment) {
    ...
    if (selAccessorials != ''){
        ...
        accFil[0] = new nlobjSearchFilter('internalid', null, 'anyof', finalSAArray);
        var accCol = [];
        accCol[0] = new nlobjSearchColumn('custrecord_pss_ratecode_e2');
        var selAccNames = nlapiSearchRecord('customrecord_pss_accessorials', null, accFil, accCol);
        for (y = 0; y < selAccNames.length; y++){
            selAccNamesPrnt.push(selAccNames[y].getValue('custrecord_pss_ratecode_e2'));
        }
    } else {var selAccNamesPrnt = '';}
    var craftedP44AssyObj = [];
    for (i = 0; i < selAccNamesPrnt.length; i++){

function containerTrack(request, response) {
  ...
  var containerId = parentShipment.getFieldValue('custrecord_pss_containerid');
  var containerTrackingId = parentShipment.getFieldValue('custrecord_pss_container_trackingid');

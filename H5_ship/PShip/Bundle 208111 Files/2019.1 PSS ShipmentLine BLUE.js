...
function AddLabel1Button(form){
    form.setScript('customscript_pss_shipmentline_blue');
...
function printboxlabel(){
    ...
    var labelId = nlapiLookupField('customrecord_pss_shipment_line',shipLineId,'custrecord_pss_label_box');
    var scriptId = nlapiLookupField('customrecord_pss_label',labelId,'custrecord_pss_label_script_id');
    var deployId = nlapiLookupField('customrecord_pss_label',labelId,'custrecord_pss_label_deploy_id');
    var recName = nlapiLookupField('customrecord_pss_shipment_line',shipLineId,'custrecord_pss_shipment_parent');
...
function printpalletlabel(){
    var shipLineId = nlapiGetRecordId();
    var labelId = nlapiLookupField('customrecord_pss_shipment_line',shipLineId,'custrecord_pss_label_pallet');
    var scriptId = nlapiLookupField('customrecord_pss_label',labelId,'custrecord_pss_label_script_id');
    var deployId = nlapiLookupField('customrecord_pss_label',labelId,'custrecord_pss_label_deploy_id');
    var recName = nlapiLookupField('customrecord_pss_shipment_line',shipLineId,'custrecord_pss_shipment_parent');
    var url = nlapiResolveURL('SUITELET', scriptId, deployId);

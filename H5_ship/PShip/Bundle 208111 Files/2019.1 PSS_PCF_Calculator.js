function calculatePCF(){
  ...
  var nmfcNumber = nlapiLookupField('customrecord_pss_nmfc_classification', nmfcVal, 'custrecord_pss_nmfc_num', 'TEXT');
  var nmfcDim = nlapiLookupField('customrecord_pss_nmfc_classification', nmfcVal, 'custrecord_pss_dim_item', 'TEXT');
  ...
  record.setFieldValue('custrecord_pss_description', nmfcNumber + '-' + dsub);

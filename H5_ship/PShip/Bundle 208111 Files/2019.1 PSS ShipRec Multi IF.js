...
function handleGet(){
  ...
  var script = "customscript_pss_shiprec_multi_if_cs";
  form.setScript('customscript_pss_shiprec_multi_if_cs');
  ...
  form.addField('custpage_pss_customer', 'select', 'Select Customer', 'customer');
...
function handlePost(){
    ...
    form.addResetButton();
    var resultCustomer = form.addField('custpage_pss_customer2', 'select', 'Select Customer', 'customer');
    //resultCustomer.setDefaultValue(request.getParameter('custpage_pss_customer'));
    var custForSearch = request.getParameter('custpage_pss_customer');

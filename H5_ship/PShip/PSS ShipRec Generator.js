//PSS ShipRec Generator
function pssShipRecGen(request, response) {
...
function poShipGen(tranId, batId, tranType) {
    ...
    var parRec = nlapiLoadRecord(recType, tranId);
    ...
    col[1] = new nlobjSearchColumn('custcolitem_weight');
    col[2] = new nlobjSearchColumn('quantity');
    col[3] = new nlobjSearchColumn('department');
    col[4] = new nlobjSearchColumn('custcol_pss_nmfc_code');
    ...
    shipLoad.setFieldValue('custrecord_pss_so_parent_id', tranId);
    ...
    for (var i = 0; i < linItems.length; i++) {
        ...
        packageClass.push(linItems[i].getValue('custcol_pss_nmfc_code'));
    }
    for (var x = 0; x < packageItem.length; x++) {
        var packLoad = nlapiCreateRecord('customrecord_pss_shipment_line');
        packLoad.setFieldValue('custrecord_pss_shipment_parent', shipLoadId);
        packLoad.setFieldValue('custrecord_pss_ship_line_item_desc', packageItem[x]);
        packLoad.setFieldValue('custrecord_pss_piece_count', packageQty[x]);
        ...
        packLoad.setFieldValue('custrecord_pss_freight_class_value', packageClass[x]);
...
function ifShipGen(tranId, batId, tranType) {
    ...
    var shipLoad = nlapiCreateRecord('customrecord_pss_shipment');
        ...
        shipLoad.setFieldValue('custrecord_pss_location',ifLocation);
        shipLoad.setFieldValue('custrecord_pss_shipper_addressee', locationAddressee);
        shipLoad.setFieldValue('custrecord_pss_shipper_addr_1', locationAddr1);
        shipLoad.setFieldValue('custrecord_pss_shipper_addr_2', locationAddr2);
        shipLoad.setFieldValue('custrecord_pss_shipper_city', locationCity);
        shipLoad.setFieldValue('custrecord_pss_shipper_state', locationState);
        shipLoad.setFieldValue('custrecord_pss_shipper_zip', locationZip);
        shipLoad.setFieldValue('custrecord_pss_shipper_country', locationCountry);
        shipLoad.setFieldValue('custrecord_pss_so_parent_id', docNum);
        shipLoad.setFieldValue('custrecord_pss_ship_date', shipDate);
        shipLoad.setFieldValue('custrecord_pss_freight_bill_to', 1318);
        shipLoad.setFieldValue('custrecord_pss_consignee_attn', destAtten);
        shipLoad.setFieldValue('custrecord_pss_consignee_addree', destAddree);
        shipLoad.setFieldValue('custrecord_pss_consignee_addr1', destAddr1);
        shipLoad.setFieldValue('custrecord_pss_consignee_addr2', destAddr2);
        shipLoad.setFieldValue('custrecord_pss_consignee_city', destCity);
        shipLoad.setFieldValue('custrecord_pss_consignee_state', destState);
        shipLoad.setFieldValue('custrecord_pss_consignee_zip', destZip);
        shipLoad.setFieldValue('custrecord_pss_consignee_country', destCountry);
        shipLoad.setFieldValue('custrecord_pss_reference_pickup', salesOrderNum);
        shipLoad.setFieldValue('custrecord_pss_reference_delivery', refAtDest);
        shipLoad.setFieldValue('custrecord_pss_billing_type', 1);
        shipLoad.setFieldValue('custrecord_pss_shiprec_type', 2);
        shipLoad.setFieldValue('custrecord_pss_shipment_direction', 2);
        shipLoad.setFieldValue('custrecord_pss_shipment_type', 2);
        //shipLoad.setFieldValue('custrecord_pss_ship_cur', shipCur);
        var shipLoadId = nlapiSubmitRecord(shipLoad);
        ...
        //lineWeights.push(parRec.getLineItemValue('item','custcol_pss_item_weight', x));
        //lineContainers.push(parRec.getLineItemValue('item','custcol_pss_packing_container', x));
        //lineMaxQtys.push(parRec.getLineItemValue('item','custcol_pss_max_cq', x));
        //     }
        // }
        ...
        for (var z = 1; z <= parRec.getLineItemCount('item'); z++) {
          ...
          packageWeight.push(Number(parRec.getLineItemValue('item','custcol_pss_item_weight', z)));
          packageQty.push(parRec.getLineItemValue('item','quantity', z));
          packageContainer.push(parRec.getLineItemValue('item','custcol_pss_packing_container', z));
          packageContCubicInches.push(parRec.getLineItemValue('item','custcol_pss_max_cq', z));
        }
        for (var z = 0; z < packageContainer.length; z++) {
          ...
          var packLoad = nlapiCreateRecord('customrecord_pss_shipment_line');
          packLoad.setFieldValue('custrecord_pss_shipment_parent', shipLoadId);
          packLoad.setFieldValue('custrecord_pss_ship_line_item_desc', packLineName[z]);
          packLoad.setFieldValue('custrecord_pss_piece_count', Math.ceil(packageQty[z] / packageContCubicInches[z]));
          packLoad.setFieldValue('custrecord_pss_packagetype', packType[z]);
          packLoad.setFieldValue('custrecord_pss_inventoryunits', packageQty[z]);
          packLoad.setFieldValue('custrecord_pss_weight', Number(Math.round(packageWeight[z] * packageQty[z]) + Number(packWeight[z]) * Math.ceil(packageQty[z] / packageContCubicInches[z])));
          packLoad.setFieldValue('custrecord_pss_length', packLength[z]);
          packLoad.setFieldValue('custrecord_pss_height', packHeight[z]);
          packLoad.setFieldValue('custrecord_pss_width', packWidth[z]);
          packLoad.setFieldValue('custrecord_pss_package_cost', packCost[z]);
          packLoad.setFieldValue('custrecord_pss_freight_class_value', packClass[z]);
          //packLoad.setFieldValue('custrecord_pss_nmfc_number', packNMFC[z]);
          //packLoad.setFieldValue('custrecord_pss_nmfc_desc', packNMFCDesc[z]);
          packLoad.setFieldValue('custrecord_pss_packingcontainer', packageContainer[z]);
          //packLoad.setFieldValue('custrecord_pss_unitprice', packUnitPrice[z]);
          //packLoad.setFieldValue('custrecord_pss_extendedtotal', packExtendedTotal[z]);
          packLoad.setFieldValue('custrecord_pss_htsnumber', packHTS[z]);
          nlapiSubmitRecord(packLoad);
    }
    response.write(shipLoadId);
}
...
function soShipGenOLD(tranId, batId, tranType) {
    ...
    for (var y = 0; y < unilocs.length; y++) {
        var shipLoad = nlapiCreateRecord('customrecord_pss_shipment');
        shipLoad.setFieldValue('name', 'Shipment #' + docNum);
        shipLoad.setFieldValue('custrecord_pss_location', unilocs[y]);
        //shipLoad.setFieldValue('custrecord_pss_shipper', unilocs[y]);
        shipLoad.setFieldValue('custrecord_pss_shipper_addr_1', origAddr[y]);
        shipLoad.setFieldValue('custrecord_pss_shipper_city', origCity[y]);
        shipLoad.setFieldValue('custrecord_pss_shipper_state', origState[y]);
        shipLoad.setFieldValue('custrecord_pss_shipper_zip', origZip[y]);
        ...
        shipLoad.setFieldValue('custrecord_pss_shipment_direction', 2);
        shipLoad.setFieldValue('custrecord_pss_shipment_type', 2);
        shipLoad.setFieldValue('custrecord_pss_shipment_status', 6);
        shipLoad.setFieldValue('custrecord_pss_shiprec_type', 1);
        shipLoad.setFieldValue('custrecord_pss_ship_cur', shipCur);
        //shipLoad.setFieldValue('custrecord_pss_shiprec_declared_value', totShipAmt);
        var shipLoadId = nlapiSubmitRecord(shipLoad);
        ...
        fils[4] = new nlobjSearchFilter('custcol_pss_item_weight', null, 'isnotempty');
        var cols = [];
        cols[0] = new nlobjSearchColumn('item');
        cols[1] = new nlobjSearchColumn('custcol_pss_item_weight');
        cols[2] = new nlobjSearchColumn('quantity');
        //cols[3] = new nlobjSearchColumn('department');
        cols[3] = new nlobjSearchColumn('custcol_pss_packing_container');
        cols[4] = new nlobjSearchColumn('custcol_pss_max_cq');
        ...
        for (var z = 0; z < lineItems.length; z++) {
            ...
            packageContCubicInches.push(lineItems[z].getValue('custcol_pss_max_cq'));
...
function soShipGen(tranId, batId, tranType) {
    ...
    var shipLoad = nlapiCreateRecord('customrecord_pss_shipment');
        shipLoad.setFieldValue('name', 'Shipment #' + docNum);
        shipLoad.setFieldValue('custrecord_pss_location',locationId);
        shipLoad.setFieldValue('custrecord_pss_shipper_addressee', locationAddressee);
        shipLoad.setFieldValue('custrecord_pss_shipper_addr_1', locationAddr1);
        shipLoad.setFieldValue('custrecord_pss_shipper_addr_2', locationAddr2);
        shipLoad.setFieldValue('custrecord_pss_shipper_city', locationCity);
        ...
        fils[1] = new nlobjSearchFilter('mainline', null, 'is', 'F');
        fils[2] = new nlobjSearchFilter('taxline', null, 'is', 'F');
        fils[3] = new nlobjSearchFilter('custcol_pss_item_weight', null, 'isnotempty');
        var cols = [];
        cols[0] = new nlobjSearchColumn('item');
        cols[1] = new nlobjSearchColumn('custcol_pss_item_weight');
        cols[2] = new nlobjSearchColumn('quantity');

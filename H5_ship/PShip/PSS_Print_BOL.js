function printBOL(request, response){
	if (request.getMethod() == 'GET') {
    	...
    	var billToZip = billToRec.getFieldValue('shipzip');
          ...
          items += '<tr><td align="center">' + linNum + '</td><td align="center">' + linPicCount + '</td><td align="left">' + linType + '</td><td align="left">' + linHazmat + '</td><td align="left">' + linDesc + '</td><td align="left">' + linNMFC + '</td><td align="left">' + linWeight + '</td></tr>';
        	}
		...
		//start of upper main table
      	...
      	xml += shipperAddr1 + ' ' + shipperAddr2 + '<br />';
      	...
      	xml += consigneeAddr1 + consigneeAddr2 + '<br />';
      	...
      	xml += '</tr>';
      	xml += '<tr><td>' + BillToName + '<br />' + billToAddr1 + ' ' + billToAddr2 + '<br />' + billToCity + ', ' + billToState + ' ' + billToZip + '</td>';
      	xml += '</tr></table>';
      	xml += '</td>';
		...
		xml += '<thead>';
		xml += '<tr>';
		xml += '<th align="center" valign="middle" style="text-align:left">Pallet</th>';
        xml += '<th style="padding: 4px 4px;text-align:left">Piece</th>';

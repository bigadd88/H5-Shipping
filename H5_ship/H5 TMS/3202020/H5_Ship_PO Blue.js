function h5poshipmentgen(type, form){
...
form.addButton('custpage_addshipment', 'Create Shipment', 'h5ShipGenInit()')
...
//get item fulfillment lines
  ...
  var col = new Array();
      ...
      col[1] = new nlobjSearchColumn('custcol_h5_item_weight');
...
shipLoad.setFieldValue('custrecord_h5_so_parent_id', soId);
...
packageWeight.push(Number(linItems[i].getValue('custcol_h5_item_weight')*10));
...
packLoad.setFieldValue('custrecord_h5_shipment_parent', shipmentId);
packLoad.setFieldValue('custrecord_h5_piece_count', packageItem[x]);
...
packLoad.setFieldValue('custrecord_h5_package_class', packageClass[x]);

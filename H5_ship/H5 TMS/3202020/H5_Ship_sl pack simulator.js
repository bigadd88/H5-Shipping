...
//calc box minimum requirement
    ...
    var itemWeight = itemRec.getFieldValue('custitem_h5_unit_weight');
    var itemLength = itemRec.getFieldValue('custitem_h5_unit_length');
    var itemWidth = itemRec.getFieldValue('custitem_h5_unit_width');
    var itemHeight = itemRec.getFieldValue('custitem_h5_unit_height');
    var itemBaseLineItemWeight = Number(itemRec.getFieldValue('custitem_h5_unit_baselineitemweight'));
    var itemPackingMaterialFactor = itemRec.getFieldValue('custitem_h5_packing_material_factor');
    //calculations
...
//search for boxes
    var containers = nlapiSearchRecord("customrecord_h5_containers",null,
        [
            ["custrecord_h5_cont_length","greaterthanorequalto", itemLength],
            "AND",
            ["custrecord_h5_cont_width","greaterthanorequalto", calcWidth],
            "AND",
            ["custrecord_h5_cont_height","greaterthanorequalto", calcHeight]
        ],
        [
            new nlobjSearchColumn("name").setSort(false),
            new nlobjSearchColumn("internalid"),
            new nlobjSearchColumn("custrecord_h5_cont_type"),
            new nlobjSearchColumn("custrecord_h5_cont_length"),
            new nlobjSearchColumn("custrecord_h5_cont_width"),
            new nlobjSearchColumn("custrecord_h5_cont_height"),
            new nlobjSearchColumn("custrecord_h5_cont_cubic_inches"),
            new nlobjSearchColumn("custrecord_h5_cont_weight"),
            new nlobjSearchColumn("custrecord_h5_cont_weight_units"),
            new nlobjSearchColumn("custrecord_h5_cont_cost")
        ]
    );
    var containerId = [];
    ...
    for (var x = 0; x < containers.length; x++) {
        ...
        volUtilizationValue.push(Math.round(containers[x].getValue('custrecord_h5_cont_cubic_inches') - calcVolume));
    ...
    var fcsRec = nlapiLoadRecord('customrecord_h5_containers', finalContainerSelected);
    var fcsLength = fcsRec.getFieldValue('custrecord_h5_cont_length');
    var fcsWidth = fcsRec.getFieldValue('custrecord_h5_cont_width');
    var fcsHeight = fcsRec.getFieldValue('custrecord_h5_cont_height');

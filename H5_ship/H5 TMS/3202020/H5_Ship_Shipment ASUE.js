function aftsubShipment(){
    var shipRecId = nlapiGetRecordId();
  	...
  	var selCarrier = shipRec.getFieldValue('custrecord_h5_carrier');
    ...
    var shipDate = shipRec.getFieldValue('custrecord_h5_ship_date');
  	...
  	var selCost = shipRec.getFieldValue('custrecord_h5_shipment_selcost');
    var costCurr = shipRec.getFieldValue('custrecord_h5_ship_cur');
    ...
    if (recStatus == 1){
        ...
        loadParRec.setFieldValue('custbody_h5_estimated_ship_cost', selCost);
        loadParRec.setFieldValue('custbody_h5_selected_carrier', selCarrier);
        ...
        loadParRec.setFieldValue('custbody_h5_shipment_cost', selCost * exchRate);
        nlapiSubmitRecord(loadParRec);
    }

    var shipperAddress = shipRec.getFieldValue('custrecord_h5_shipper_addr_1');
    var shipperCity = shipRec.getFieldValue('custrecord_h5_shipper_city');
    var shipperState = shipRec.getFieldValue('custrecord_h5_shipper_state');
    ...
    var consigneeAddress = shipRec.getFieldValue('custrecord_h5_consignee_addr1');
    var consigneeCity = shipRec.getFieldValue('custrecord_h5_consignee_city');
    var consigneeState = shipRec.getFieldValue('custrecord_h5_consignee_state');
    ...
    shipRec.setFieldValue('custrecord_h5_shipper_lat', shipperLat);
    shipRec.setFieldValue('custrecord_h5_shipper_lng', shipperLng);
    shipRec.setFieldValue('custrecord_h5_consignee_lat', consigneeLat);
    shipRec.setFieldValue('custrecord_h5_consignee_lng', consigneeLng);

...
function customClearance(request, response) {
    if (request.getMethod() == 'GET') {
        ...
        var consigneeName = record.getFieldText('custrecord_h5_consignee');
        ...
        var termsOfSale = record.getFieldValue('custrecord_h5_termsofsale');
        var shipCurrency = record.getFieldText('custrecord_h5_ship_cur');
        ...
        var consigneeIRS = record.getFieldValue('custrecord_h5_buyer_irs_number');
        ...
        col[1] = new nlobjSearchColumn('custrecord_h5_htsnumber');
        ...
        col[7] = new nlobjSearchColumn('custrecord_h5_piece_count');
        col[8] = new nlobjSearchColumn('custrecord_h5_inventoryunits');
        ...
        for (var x = 0; x < packages.length; x++) {
            ...
            var linItemQty = packages[x].getValue('custrecord_h5_inventoryunits');

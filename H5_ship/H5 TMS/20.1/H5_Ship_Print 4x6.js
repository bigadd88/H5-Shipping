function print4x6Label(request, response){
    if (request.getMethod() == 'GET') {
      ...
      var carrierPRO = record.getFieldValue('custrecord_h5_carrier_pro');
      ...
      var salesTransId = record.getFieldValue('custrecord_h5_so_parent_id');
      ...
      var xml = '<?xml version=\"1.0\"?>\n<!DOCTYPE pdf PUBLIC \"-//big.faceless.org//report\" \"report-1.1.dtd\">\n';
        ...
        xml += '<head>';
      	xml += '<meta name="H5Label" value="PSS 4x6 Label"/>';

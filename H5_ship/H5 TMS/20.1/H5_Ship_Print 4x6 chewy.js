function print4x6Chewy(request, response){
    if (request.getMethod() == 'GET') {
        var recId = request.getParameter('recName');
        var logoURL = '';
        var shipLine = nlapiLoadRecord('customrecord_h5_shipment_line', recId, null, null);
        var SHIPLINE_pkgnumber = shipLine.getFieldValue('custrecord_h5_pkgnumber');
        var SHIPLINE_pallet_count = shipLine.getFieldValue('custrecord_h5_pallet_count');
        var SHIPLINE_piece_count = shipLine.getFieldValue('custrecord_h5_piece_count');
        var SHIPLINE_packagetype = shipLine.getFieldValue('custrecord_h5_packagetype');
        var SHIPLINE_ship_line_item_desc = shipLine.getFieldValue('custrecord_h5_ship_line_item_desc');
        var SHIPLINE_nmfc_number_line = shipLine.getFieldValue('custrecord_h5_nmfc_number_line');
        var SHIPLINE_freight_class_value = shipLine.getFieldValue('custrecord_h5_freight_class_value');
        var SHIPLINE_weight = shipLine.getFieldValue('custrecord_h5_weight');
        var SHIPLINE_length = shipLine.getFieldValue('custrecord_h5_length');
        var SHIPLINE_width = shipLine.getFieldValue('custrecord_h5_width');
        var SHIPLINE_height = shipLine.getFieldValue('custrecord_h5_height');
        var SHIPLINE_hazmat = shipLine.getFieldValue('custrecord_h5_hazmat');
        var SHIPLINE_shipment_parent = shipLine.getFieldValue('custrecord_h5_shipment_parent');
        var SHIPLINE_pcf = shipLine.getFieldValue('custrecord_h5_pcf');
        var SHIPLINE_nmfc_desc = shipLine.getFieldValue('custrecord_h5_nmfc_desc');
        var SHIPLINE_nmfc_number = shipLine.getFieldValue('custrecord_h5_nmfc_number');
        var SHIPLINE_package_department = shipLine.getFieldValue('custrecord_h5_package_department');
        var SHIPLINE_package_class = shipLine.getFieldValue('custrecord_h5_package_class');
        var SHIPLINE_inventoryunits = shipLine.getFieldValue('custrecord_h5_inventoryunits');
        var SHIPLINE_shipline_freight_class = shipLine.getFieldValue('custrecord_h5_shipline_freight_class');
        var SHIPLINE_nmfc_short_desc_line = shipLine.getFieldValue('custrecord_h5_nmfc_short_desc_line');
        var SHIPLINE_countryoforigin = shipLine.getFieldValue('custrecord_h5_countryoforigin');
        var SHIPLINE_unitprice = shipLine.getFieldValue('custrecord_h5_unitprice');
        var SHIPLINE_extendedtotal = shipLine.getFieldValue('custrecord_h5_extendedtotal');
        var SHIPLINE_htsnumber = shipLine.getFieldValue('custrecord_h5_htsnumber');
        var SHIPLINE_shipline_salesunit = shipLine.getFieldValue('custrecord_h5_shipline_salesunit');
        var SHIPLINE_itemunitweight = shipLine.getFieldValue('custrecord_h5_itemunitweight');
        var SHIPLINE_packingcontainer = shipLine.getFieldValue('custrecord_h5_packingcontainer');
        var SHIPLINE_itemcontainer = shipLine.getFieldValue('custrecord_h5_itemcontainer');
        var SHIPLINE_shipline_if_id = shipLine.getFieldValue('custrecord_h5_shipline_if_id');
        var SHIPLINE_salesorderlink = shipLine.getFieldValue('custrecord_h5_salesorderlink');
        ...
        var SHIPLINE_itemlink = shipLine.getFieldValue('custrecord_h5_itemlink');
        var itemDescription = nlapiLookupField('item', SHIPLINE_itemlink, 'itemid');
        var itemInnerUnits = nlapiLookupField('item', SHIPLINE_itemlink, 'custitem_h5_inner_container_units');
        var SHIPLINE_label_box = shipLine.getFieldValue('custrecord_h5_label_box');
        var SHIPLINE_label_pallet = shipLine.getFieldValue('custrecord_h5_label_pallet');
        var SHIPLINE_box_length = shipLine.getFieldValue('custrecord_h5_box_length');
        var SHIPLINE_box_width = shipLine.getFieldValue('custrecord_h5_box_width');
        var SHIPLINE_box_height = shipLine.getFieldValue('custrecord_h5_box_height');
        var SHIPLINE_box_weight = shipLine.getFieldValue('custrecord_h5_box_weight');
        ...
        xml += '</macrolist>';
        xml += '</head>';
        xml += '<body padding="0.1in 0.1in 0.2in 0.1in" width="101mm" height="152mm" footer="myfooter" footer-height="0em">';

        var i = 0;
        while (i < SHIPLINE_piece_count) {
            xml += '<pbr />'; //pagebreak
            xml += '<table style="width: 100%"><tr>';
            xml += '<td style="border-top-style:solid;border-top-width:0pt;border-left-style:solid;border-left-width:0pt;border-bottom-style:solid;border-bottom-width:.5pt;border-right-style:solid;border-right-width:0pt">';
            ...
            xml += '</td>';
            xml += '<td style="border-top-style:solid;border-top-width:0pt;border-left-style:solid;border-left-width:.5pt;border-bottom-style:solid;border-bottom-width:.5pt;border-right-style:solid;border-right-width:0pt">';
            xml += '<p class="s2" align="center" style="padding-top: 5pt;padding-left: 0pt;text-indent: 0pt;">'+customerName+'</p>';
            xml += '<p class="s2" align="center" style="padding-top: 5pt;padding-left: 0pt;text-indent: 0pt;">PO#: '+customerPO+'</p>';
            xml += '<p class="s2" align="center" style="padding-top: 5pt;padding-left: 0pt;text-indent: 0pt;">'+ itemDescription +'</p>';
            xml += '<p class="s2" align="center" style="padding-top: 5pt;padding-left: 0pt;text-indent: 0pt;">TOTAL QTY: ' + itemInnerUnits + ' PCS</p>';

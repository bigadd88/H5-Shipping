...
define(["N/http", "N/ui/serverWidget", "N/url", "N/log"], function (http, ui, url, log){
    ...
    function generateForm(shipParentId){
        ...
        form.addField({
            id: 'custpage_h5_qrdate',
            type: ui.FieldType.DATE,
            label: 'Shipment Date'
        });
        form.addField({
            id: 'custpage_h5_qrshipmentclass',
            type: ui.FieldType.TEXT,
            label: 'Freight Class',
            //source: 'customlist_pri_freightclass'
        });
        form.addField({
            id: 'custpage_h5_qrweight',
            type: ui.FieldType.TEXT,
            label: 'Weight'
        });
      	form.addField({
            id: 'custpage_h5_palletcount',
            type: ui.FieldType.TEXT,
            label: 'Pallet Count'
        });
        form.addField({
            id: 'custpage_h5_ocity',
            type: ui.FieldType.TEXT,
            label: 'Origin City'
        }); 
        form.addField({
    ...
    function getFormData(context) {
        ...
        return {
            originCity: context.request.parameters.custpage_h5_ocity,
            originZip: context.request.parameters.custpage_h5_ozip,
            destinationCity: context.request.parameters.custpage_h5_dcity,
            destinationZip: context.request.parameters.custpage_h5_dzip,
            weight: context.request.parameters.custpage_h5_qrweight,
            shipmentClass: context.request.parameters.custpage_h5_qrshipmentclass,
            profileCode: 'SD68R',
            clientCode: 'SD688',
            shipmentDate: context.request.parameters.custpage_h5_qrdate,
            palletCount: context.request.parameters.custpage_h5_palletcount
        };
    }

...
function getInjectableForm(){
    ...
    bodyAreaField.defaultValue = '<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="NO-CACHE"><meta name="viewport" content="width=device-width, initial-scale=1.0"><script>var script = document.createElement(\'script\');script.setAttribute(\'type\', \'text/javascript\');script.appendChild(document.createTextNode(\"' + scriptToInject + '\" ));document.body.appendChild(script);</script>';
    return form;
}
...
function getBody(){
    return "<div style='width:100%' class='container-fluid'> "
        ...
        +"<div id=contentToChange>"
            ...
            + "<button type='button' class='btn btn-dark btn-lg btn-block' onClick='goInvTransfer();' > Inventory Transfer</button>"
            + "<button type='button' class='btn btn-dark btn-lg btn-block' onClick='goSavedPicks();' >Saved Picks</button>"
            + "<button type='button' class='btn btn-dark btn-lg btn-block' onClick='goInvoice();' >New Pick</button>"
...
var clientCode  = 'run(); ' + function run() {
    ...
    function injectHeaderScripts(){
        ...
        loadjscssfile("https://1212003-sb1.app.netsuite.com/core/media/media.nl?id=701884&c=1212003_SB1&h=a8c169999fece64f7bbb&_xt=.js");

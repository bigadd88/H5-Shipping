...
function addInventoryItem(){
  ...
  row.innerHTML += '<tr><td class="pt-3-half"contenteditable="true"><input id="item"type="text"onchange="validateItem(this);"></td><td class="pt-3-half"contenteditable="true"><input id="quantity"type="tel"></td><td class="pt-3-half"contenteditable="true"><input id="price"type="number"></td><td><input type="button" onclick="removeRow(this)" class="btn btn-danger btn-rounded btn-sm" value="delete"></td></tr>'
  TABLEROWS++;
}

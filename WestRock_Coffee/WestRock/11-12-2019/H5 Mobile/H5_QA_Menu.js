...
function getBody(){
    ...
    return  "<div id='navi'></div>"
        +"<div  style='width:100%; text-align:center' >Scan a Work Order Number<input style='width:100% text-align:center' id='wonumber' > </input></div>"
        +"<button style='width:100%; background-color:#F6F5D7; padding: .8%; ' onclick='to_QA_Lab()'> Lab Sample </button>"
        +"<button style='width:100%; background-color:#F6F5D7; padding: .8%; '> Brew Test </button>"
        +"<button style='width:100%; background-color:#F6F5D7; padding: .8%; '> Time Interval Test </button>"
        +"<button style='width:100%; background-color:#F6F5D7; padding: .8%; ' onclick='woInquiry();' > WO Inquiry </button>"
        +"<button style='width:100%; background-color:#696464; padding: .8%; '> Log Out </button>"
...
var clientCode  = 'run(); ' + function run() {
    ...
    function injectHeaderScripts(){
        console.log('loadHeaderLibraries START');
         ...
         loadjscssfile("https://1212003.app.netsuite.com/core/media/media.nl?id=577191&c=1212003&h=77445b5e5b2af9e1c8ee&_xt=.js"); // CLIENT SCRIPT

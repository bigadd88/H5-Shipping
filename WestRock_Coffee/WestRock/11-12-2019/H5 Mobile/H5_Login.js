...
function getBody(){
    return "<div style='width:100%' class='container-fluid'> " +
        ...
        "<nav class='navbar navbar-dark' style='background-color: #A22A2F'>"
        +" <a class='navbar-brand' style='color: white'>WestRock QA Mobile</a>"
        +"</nav>"
        ...
        +"<input id='login' class='btn btn-primary' type='button' style='background-color: #E7A622 ' name='login' value='LogIn' onclick='toMenu();'></div>"

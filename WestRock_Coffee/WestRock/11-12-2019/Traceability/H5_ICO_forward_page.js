...
function getBody(){
  ...
  return "<div class='border border-light p-5'><p class='h4 mb-4 text-center'>Enter an ICO Number to Trace Forward to Item Fulfillments</p> <input type='text' id='icoId' class='form-control mb-4' placeholder='ICO #'> <button class='btn btn-info btn-block' onclick='lotFindForward()'>Fetch Data. Good Dog.</button><div><p id='roastedWOLabel'>Roasting Work Order Ids</p><p id='roastedWO'></p><p id='roastedBuildLabel'>Roasting AssemblyBuilds Ids</p><p id='roastedBuild'></p><p id='supersacksLabel'>Super Sack Lots Produced Ids</p><p id='supersacks'></p><p id='fgAssemblyBuildsLabel'>FG AssemblyBuilds Ids</p><p id='fgAssemblyBuilds'></p><p id='fgPalletIdsLabel'>FG Pallets Ids</p><p id='fgPalletIds'></p><p id='results'></p></div></div>";
...
var clientCode  = 'run(); ' + function run() {
    ...
    function injectHeaderScripts(){
        console.log('loadHeaderLibraries START');
         ...
         loadjscssfile("https://1212003.app.netsuite.com/core/media/media.nl?id=627217&c=1212003&h=b0a5b7e26f3da6c28fa8&_xt=.js"); // CLIENT SCRIPT
    ...
    function runCustomFunctions() {
        ...
        document.title = 'Trace ICO Number';
    }

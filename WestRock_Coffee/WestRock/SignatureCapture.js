...
function getBody(){
    return "<div style='width:100%' class='container-fluid'> "
        ...
        +"<div><img src='https://preview.ibb.co/jnW4Qz/Grumpy_Cat_920x584.jpg' width=400 height=200 /><canvas id='signature-pad' width=400 height=200></canvas></div><div><button id='save'>Save</button><button id='clear'>Clear</button></div>"
        +"</div>"
        + "</div>";
}
...
var clientCode  = 'run(); ' + function run() {
    ...
    function injectHeaderScripts(){
        ...
        loadjscssfile("https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js");
          loadjscssfile("https://3617346-sb1.app.netsuite.com/core/media/media.nl?id=4940858&c=3617346_SB1&h=6693df22e0a3ea8c276f&_xt=.js");

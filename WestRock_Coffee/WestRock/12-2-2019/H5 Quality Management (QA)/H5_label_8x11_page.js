...
function intlCommercialInvoice(request, response) {
    if (request.getMethod() == 'GET') {
        ...
        var containerId = record.getFieldValue('custrecord_pss_containerid');
        var sealNum = record.getFieldValue('custrecord_pss_sealnum');
        var incoTerm = record.getFieldText('custrecord_pss_incoterms');
        var skidSize = record.getFieldValue('custrecord_pss_skid_size_forcontainer');
        ...
        var finalCountryOfOrigin = shipperCountry;
        var coforig = record.getFieldValue('custrecord_pss_countryoforigin');
        if(coforig === null){finalCountryOfOrigin = shipperCountry;} else {finalCountryOfOrigin = coforig;}
        var consigneeAddressee = record.getFieldValue('custrecord_pss_consignee_addree');
        var prntConsigneeAddressee = consigneeAddressee.replace('&','&amp;');
      ...
      var prntConsigneeAddr2 = consigneeAddr2.replace('&','&amp;');
        ...
        }   else {consigneeCountry = record.getFieldValue('custrecord_pss_consignee_country');
            }
        ...
        }   else {notificationPartyCountry = record.getFieldValue('custrecord_pss_notificationparty_country');}
        ...
        var notificationPartyMOB = record.getFieldValue('custrecord_pss_notificationparty_mob');
        ...
        var currencyDisplay = record.getFieldText('custrecord_pss_ship_cur');
        ...
        col[9] = new nlobjSearchColumn('custrecord_pss_itemunitweight');
        col[10] = new nlobjSearchColumn('custrecord_pss_pallet_count');
        col[11] = new nlobjSearchColumn('custrecord_pss_shipline_salesunit');
        ...
        for (var x = 0; x < packages.length; x++) {
            ...
            var linPalletCount = packages[x].getValue('custrecord_pss_pallet_count');
            ...
            var linSalesUnit = packages[x].getText('custrecord_pss_shipline_salesunit');
            ...
            var itemUnitWeight = packages[x].getValue('custrecord_pss_itemunitweight');
        ...
        try {
          ...
          */
          ...
          xml += '<p class="s2" style="padding-top: 0pt;padding-left: 20pt;text-indent: 0pt;text-align: left;">' + prntConsigneeAddressee + '</p>';
          xml += '<p class="s2" style="padding-top: 0pt;padding-left: 20pt;text-indent: 0pt;text-align: left;">' + consigneeAddr1 + '</p>';
          xml += '<p class="s2" style="padding-top: 0pt;padding-left: 20pt;text-indent: 0pt;text-align: left;">' + prntConsigneeAddr2 + '</p>';
          ...
          xml += '<p class="s2" style="padding-top: 2pt;padding-left: 20pt;text-indent: 0pt;text-align: left;">Country of Origin: <b>' + finalCountryOfOrigin +'</b></p>';
          xml += '</td>';
          xml += '</tr>';

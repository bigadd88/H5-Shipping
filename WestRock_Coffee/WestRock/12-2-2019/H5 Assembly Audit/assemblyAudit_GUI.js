...
function getBody(){
    ...
    return "<div>"
            +"<p align='center' id='Qty'></p>"
            +"<p align='center' id='id'></p>"
            +"<p align='center' id='name'></p>"
            +"<p align='center' id='extra'></p>"
            +"</div>"
...
var clientCode  = 'run(); ' + function run() {
    ...
    function injectHeaderScripts(){
        console.log('loadHeaderLibraries START');
         ...
         loadjscssfile("https://1212003.app.netsuite.com/core/media/media.nl?id=631538&c=1212003&h=5bd1e9c2b5eb9ba875f7&_xt=.js"); // CLIENT SCRIPT
    ...
    function runCustomFunctions() {
        ...
        parm = getParameter('assemblybuild');
        assemblyBuildAudit(parm);

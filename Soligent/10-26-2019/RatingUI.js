...
function getBody(){
    ...
    return  "<div class='card-deck'>"
            ...
            +"<div class='card text-white bg-dark mb-3'>"
                  ...
                  +"<thead>"
                //  +"<tr><th><p align='Left'>Assisoral</p></th><th><p >YES/NO</p></th></tr>"
                  +"</thead>"
                  +"<tbody>"
                  +"<tr>  <td>From Zip</td>  <td>To Zip</td>  </tr>"
                  +"<tr>  <td><input id='fromZip'></input></td>  <td><input id='toZip'></input></td></tr>"

                  +"<tr> <td>Pallets</td> <td>Pieces</td> <td>Weight</td> <td></td> </tr>"
                  +"<tr> <td><input id='pallets'></input></td><td><input id='pieces'></input></td><td><input id='weight'></input></td> </tr>"
                  +"<tr><td></td> <td>FULL SERVICE</td> <td><input type='Checkbox' id='FS'></input></td><td></td></tr>"
                //  +"<tr><td></td> <td>DOCK TO DOCK</td> <td><input type='Checkbox' id='DTD'></input></td><td></td></tr>"
                  +"<tr><td></td> <td>SAME DAY</td> <td><input type='Checkbox' id='SameDay'></input></td><td></td></tr>"
                  +"<tr><td></td> <td>SATURDAY</td> <td><input type='Checkbox' id='Sat'></input></td><td></td></tr>"
                  +"<tr><td></td> <td>AM request</td> <td><input type='Checkbox' id='AM'></input></td><td></td></tr>"
                  +"<tr><td></td> <td>RMA</td> <td><input type='Checkbox' id='RMA'></input></td><td></td></tr>"
                  +"<tr> <td></td><td>BLIND</td> <td><input type='Checkbox' id='Blind'></input></td><td></td></tr>"
                //  +"<tr> <td></td><td>STANDBY</td> <td><input type='Checkbox' id='StandBy'></input></td><td></td></tr>"
